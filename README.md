...
**Problem**: Canvas not appearing
- Solution: Check browser console for errors, ensure server is running

**Problem**: Drawings not syncing
- Solution: Verify WebSocket connection, check network tab in browser

**Problem**: Server crashes on startup
- Solution: Ensure port 3000 is not in use, run `npm install` again
